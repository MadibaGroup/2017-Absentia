...
\begin{table}[t]
	...
	\end{tabular}
	\caption{Comparison between deploying a PET on Ethereum and deploying on Arbitrum (via Ethereum). The links show the reader the actual transactions of a test-run on Kovan/Arbitrum's respective block explorers.} 
	\label{tab:arbitrum}
\end{table}