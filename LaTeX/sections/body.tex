...
A run of PET on Ethereum costs 9,011,425 gas (or \textblue{XXX} USD), while on Arbitrum the cost is 531,697 gas (or \textblue{XXX} USD). In this use case, Arbitrum reduces Ethereum gas costs by 94\%.  
