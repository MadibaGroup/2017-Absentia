...
contract mixmatch 
{
    ...
    function createRow1(uint256[] memory alice1,  uint256[] memory bob1, uint256 stage) public 
    {
        require(count == 2);
        require(balances[alice] >= 10);
        require(balances[bob] >= 10);
        pet_row1col1 = new PET(alice1, stage);
        pet_row1col2 = new PET(bob1, stage);   
        count++;
        emit rowAddresses(address(pet_row1col1),address(pet_row1col2));
    }
    function createRow2(uint256[] memory alice1, uint256[] memory bob1, uint256 stage) public 
    {
        require(count == 3);
        require(balances[alice] >= 10);
        require(balances[bob] >= 10);
        pet_row2col1 = new PET(alice1, stage);
        pet_row2col2 = new PET(bob1, stage); 
        count++;  
        emit rowAddresses(address(pet_row2col1),address(pet_row2col2));
    }

    function createRow3(uint256[] memory alice1,  uint256[] memory bob1, uint256 stage) public 
    {
        require(count == 4);
        require(balances[alice] >= 10);
        require(balances[bob] >= 10);
        pet_row3col1 = new PET(alice1, stage);
        pet_row3col2 = new PET(bob1, stage); 
        count++;  
        emit rowAddresses(address(pet_row3col1),address(pet_row3col2));
    }

    function createRow4(uint256[] memory alice1, uint256[] memory bob1,  uint256 stage) public 
    {
        require(count == 5);
        require(balances[alice] >= 10);
        require(balances[bob] >= 10);
        pet_row4col1 = new PET(alice1, stage);
        pet_row4col2 = new PET(bob1, stage); 
        count++;  
   ...
   function createFinalDecryption(uint256[] memory alice1, uint256 stage) public
    {
        require(count == 8);
        require(balances[alice] >= 10);
        require(balances[bob] >= 10);
        // finalResult = new finalDecryption();
        finaldec = new PET(alice1,stage);
        count++;
        if(trustee1.send(10))
        {
