...
library ec{
    ...
    uint256 constant public pts = 115792089237316195423570985008687907852837564279074904382605163141518161494337;
    uint256 constant n = p ;

    
    // *********************
// from https://github.com/orbs-network/elliptic-curve-solidity/blob/master/ECops.sol
    function inverse(uint256 num) public 
    ...
    function toAffinePoint(uint256 x0, uint256 y0, uint256 z0) public 
    ...
    function isZeroCurve(uint256 x0, uint256 y0) public 
        returns(bool isZero)
    {
        if(x0 == 0 && y0 == 0) {
            return true;
    ...
    function twiceProj(uint256 x0, uint256 y0, uint256 z0) public 
    ...
    function addProj(uint256 x0, uint256 y0, uint256 z0,
                     uint256 x1, uint256 y1, uint256 z1) public 
    ...
    function twice(uint256 x0, uint256 y0) public 
        returns(uint256 x1, uint256 y1)
    {
        uint256 z0;
