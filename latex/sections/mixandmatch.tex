...
~\textbf{Alice:} can call loadFunds more than once. She has to call loadCiphertexts for each PET (4 times).

~\textbf{Bob:} can call loadFunds more than once. He has to call loadCiphertexts for each PET (4 times).
